        ...
        <div class="content mt-3">
            <div class="col-sm-12">
                <div class="card-body card-block">
                    <form action="atualiza_liv.php?codLivro=<?php echo $codLivro; ?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="row form-group">
                            <div class="col col-md-3">
                                <label for="qtdExemplares" class=" form-control-label">Quantidade de Exemplares</label>
                            </div>
                        <div class="col-12 col-md-9">
                                <input type="text" id="qtdEexemplares" name="qtdExemplares" value="<?php echo $linha['qtdExemplares']; ?>" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <select name="genero" id="genero" value="<?php echo $linha['genero']; ?>" class="form-control">
