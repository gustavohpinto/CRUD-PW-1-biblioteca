                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                                ...
                                                <?php
                                                    $consulta ="SELECT * FROM aluno_cliente ORDER BY nome asc";
                                            ...
                                            <?php
                                                ...
                                                foreach ($conexao -> query($consulta) as $linha) {
                                                        ...
                                                        echo" <tr>";
                                                            ...
                                                            echo "<td>".$linha['qtdExemplares'] ."</td>";
                                                        echo" </tr>";

                                            ?>

                                                <td>
                                                        <a href="atualiza_livro.php?codLivro=<?php echo $linha['codLivro']; ?>" class="btn btn-primary"> Atualizar </a>
                                                        &nbsp; &nbsp;
